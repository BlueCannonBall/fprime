...
int main(int argc, const char* argv[]) {
    ...
    try {
        ...
        desc.add_options()("help,h", "This help screen")("start-num", value(&start_num)->required(), "Starting number")("end-num", value(&end_num)->required(), "Ending number")("threads,t", value(&thread_count), "Amount of threads, depends on hardware thread count by default");
